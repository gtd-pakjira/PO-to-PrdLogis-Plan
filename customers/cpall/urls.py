...
urlpatterns = [
    ...
    path("templates/<str:key>/versions/<int:version_id>/restore/", views.template_version_restore,name="template_version_restore"),
     path("templates/<str:key>/versions/<int:version_id>/reconcile/",views.template_version_reconcile,name="template_version_reconcile",),
     path("templates/<str:key>/versions/<int:version_id>/product-action/",views.template_version_product_action,name="template_version_product_action",),
     path("templates/<str:key>/versions/<int:version_id>/delete/", views.template_version_delete,name="template_version_delete"),
     ...
     path("templates/<str:key>/versions/<int:version_id>/download/",views.template_version_download, name="template_version_download",),
