...
#
# เดิม hardcode เป็น list ตายตัว — เปลี่ยนเป็น query สดจาก LocationMapping แทน (2026-09-05) เพราะ
...
def get_skipped_skus(plan_run_id: int) -> list:
    ...
    *** สินค้าที่ inactive ไม่รวมอยู่ในผลลัพธ์นี้เลย (ตัดออกตั้งแต่ 2026-09-05) *** — เดิมเคยแยกเป็น
...
def suggest_vehicle_size(plan_run_id: int, group_name: str):
    """
    แนะนำขนาดรถตามยอดตะกร้ารวมของกลุ่ม logistic นี้ (2026-09-12) — รวมตะกร้าทุกคอลัมน์ (จุดส่ง x PO)
